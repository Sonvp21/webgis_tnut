...
<head>
    ...
    <title>{{ env('APP_NAME', 'Đắk Lắk MAP - TNUT') }}</title> <!-- Meta Tags -->
    <meta name="author" content="{{ env('APP_NAME', 'Đắk Lắk MAP - TNUT') }}">
    <meta name="keywords" content="Đắk Lắk MAP - TNUT, admin, dashboard, ui, kit">
    <meta name="description"
        content="Welcome to {{ env('APP_NAME', 'Đắk Lắk MAP - TNUT') }}. Visit us at {{ env('APP_URL', 'http://testweb.test/') }}">
    <!-- Open Graph Meta -->
    <meta property="og:title" content="{{ env('APP_NAME', 'Đắk Lắk MAP - TNUT') }}">
    <meta property="og:description"
        content="Welcome to {{ env('APP_NAME', 'Đắk Lắk MAP - TNUT') }}. Visit us at {{ env('APP_URL', 'http://testweb.test/') }}">
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ env('APP_URL', 'http://testweb.test/') }}">
